...
export class VenteService {
  ...
  create(vente, encaissement, rendu, montantTotal, idUser) {
      ...
      .set('idUser', idUser);
      return this.http.post(this.API_URL + '/ventes/create', vente, {headers: headers, params: param});
  }

  getAll(): any {
    const headers = new HttpHeaders({ 'Content-Type': 'application/json' });
    headers.append('Authorization', 'Bearer ' + this.token);
    return this.http.get<Vente[]>(this.API_URL + '/ventes/retrieveListVentes', {headers: headers});
  }
  ...
  getDetailsVente(idVente): any {
    ...
    const param = new HttpParams()
    .set('idVente', idVente);
    return this.http.get(this.API_URL + '/ventes/retrieveDetailsVentes', {headers: headers, params: param});
  }
